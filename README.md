## nmea_navsat_driver (jazzy) - 2.0.1-4

The packages in the `nmea_navsat_driver` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy nmea_navsat_driver --override-release-repository-push-url git@github.com:revyos-ros/nmea_navsat_driver-release` on `Mon, 24 Jun 2024 12:42:24 -0000`
...
- release repository: https://github.com/revyos-ros/nmea_navsat_driver-release.git
...
## nmea_navsat_driver (iron) - 2.0.1-1
